...
import { getFollowerList, followUser, unfollowUser, getUserStats } from '@/api/community'
...
const fetchFollowerList = async () => {
  ...
  try {
    const [res, statsRes] = await Promise.all([
      getFollowerList(userId.value, currentPage.value, pageSize.value),
...
watch(userId, (newId, oldId) => {
  if (newId && newId !== oldId) { currentPage.value = 1; fetchFollowerList() }
})
    ...
    <div class="page-container">
      <div class="page-header">
        ...
        <div class="header-title-row">
          <h1 class="page-title">
            <i class="i-carbon-user-multiple mr-2" />粉丝列表
          </h1>
...
.user-card {
  ...
  .card-banner {
    ...
    .banner-avatar-wrap {
      ...
      .avatar-glow {
        ...
        opacity: 0.5; filter: blur(6px); z-index: 0;
  ...
  .card-body {
    ...
    .follow-btn { border-radius: 20px; flex-shrink: 0; }
  }
}
